...
export default function CarouselSlideHero({
  ...
  return (
    <div className={className}>
      ...
      <div className="max-w-screen-lg w-full flex flex-col gap-3 sm:gap-7 justify-center pl-[10%] lg:pl-[102.4px]">
        <div>
          <div
        ...
        <div className="flex flex-col gap-1 items-start">
          <ButtonCustom
            ...
            className="font-n2r text-xs w-32 h-8 bg-[#E4002B] text-white hover:border-2 hover:border-[#E4002B] hover:bg-white hover:text-[#E4002B]"
          >
            Order Now
          </ButtonCustom>
